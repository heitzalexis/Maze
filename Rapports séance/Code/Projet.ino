#include <NewPing.h>  //importation de la bibliothèque NewPing utile pour les sensors

//Définition de variables utiles pour les sensor
...
//Affichage du résultat des différents ping utiles pour les tests
  ...
  /*Serial.print("PWM Moteur Droit :");
  Serial.print();
  Serial.print("    |    ");
  Serial.print("PWM Moteur Gauche :");
  Serial.println();*/
